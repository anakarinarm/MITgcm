# HR full-TPXO GEBCO W117.75 amplitude sensitivity: 0.5x tide

This run is the half-amplitude member of the preliminary tidal-amplitude
sensitivity pair.
...
on W/S/N are multiplied by `0.5`.
...
```bash
mkdir -p /Volumes/LaCie/MITgcm_outputs/intTides_PBC_smalldom_HR/runProd_HR_fullTPXO_gebcoW11775_amp050_momentumEnergy
rm -rf output
ln -s /Volumes/LaCie/MITgcm_outputs/intTides_PBC_smalldom_HR/runProd_HR_fullTPXO_gebcoW11775_amp050_momentumEnergy output
```

## Run

```bash
cd intTides_PBC_smalldom_HR/runProd_HR_fullTPXO_gebcoW11775_amp050_momentumEnergy
